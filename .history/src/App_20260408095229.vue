              ...
              <div v-for="(question, questionindex) in basicQuestions" :key="question.id" class="question-card">
                <div class="question-header">
                  ...
                  <div class="question-actions">
                    <a-button size="small" @click="moveQuestion(question.id, 'up')" :disabled="questions.indexOf(question) === 0">⬆️ 上移</a-button>
                    <a-button size="small" @click="moveQuestion(question.id, 'down')" :disabled="questions.indexOf(question) === questions.length - 1">⬇️ 下移</a-button>
