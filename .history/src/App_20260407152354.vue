...
<template>
  <div class="app-container">
        ...
        <div v-for="question in questions" :key="question.id" class="question-card">
          ...
          <div class="options-area">
            <template v-if="question.type === 'multiple'">
              <a-checkbox-group v-model:value="question.correctOptions">
                <a-checkbox 
            ...
            <template v-else>
              <a-radio-group v-model:value="question.correctOption">
                <a-radio 
                  v-for="(option, index) in question.options" 
                  :key="index" 
                  :value="index"
          ...
          <div class="flex-between">
            <span>分值: <a-input-number v-model:value="question.score" :step="1" class="score-input" /> 分</span>
        ...
        <div class="settings-panel">
          ...
          <div class="settings-grid">
            ...
            <div class="setting-field">
              ...
              <a-select v-model:value="settings.allowRepeat">
                <a-select-option :value="false">不允许 (每人仅一次)</a-select-option>
                <a-select-option :value="true">允许重复答题</a-select-option>
              </a-select>
            </div>
            <div class="setting-field">
          ...
          <div style="margin-top: 10px; margin-left: 20px;">
            ...
            <template v-else-if="question.type === 'multiple'">
              <a-checkbox-group v-model:value="previewAnswers[question.id]">
                <div v-for="(option, optIndex) in question.options" :key="optIndex" style="margin-bottom: 8px; display: flex; align-items: center; gap: 8px;">
                  <a-checkbox :value="optIndex"></a-checkbox>
    ...
    <!-- 添加题目模态框 -->
    <div class="preview-modal" v-if="showAddQuestionModal" @click="showAddQuestionModal = false">
      <div class="preview-card" @click.stop>
        <div style="display:flex; justify-content: space-between; align-items: center;">
          <h3>📝 添加题目</h3>
          <span style="cursor:pointer; font-size:24px;" @click="showAddQuestionModal = false">&times;</span>
        </div>
        ...
        <!-- 题干输入 -->
        <div style="margin-bottom: 20px;">
          <label style="display: block; font-weight: 600; margin-bottom: 8px;">题干</label>
          <textarea 
        ...
        <div style="margin-bottom: 20px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            ...
            <button class="btn btn-outline" @click="addOption" style="font-size: 12px; padding: 4px 12px;">+ 添加选项</button>
          </div>
            ...
            <a-checkbox-group v-model:value="newQuestion.correctOptions">
              <div v-for="(option, index) in newQuestion.options" :key="index" style="margin-bottom: 12px; display: flex; align-items: center; gap: 12px;">
                ...
                <input 
                  v-model="option.text" 
                  placeholder="选项内容" 
                  style="flex: 1; padding: 8px 12px; border: 1px solid #cbd5e1; border-radius: 8px;"
                >
                <button 
                  class="btn btn-outline" 
                  @click="removeOption(index)" 
                  style="font-size: 12px; padding: 4px 12px; color: #ef4444; border-color: #fecaca;"
                >
                  删除
                </button>
              </div>
        ...
        <div style="margin-bottom: 20px;">
          ...
          <input 
            ...
            step="1" 
            min="1" 
            style="width: 100px; padding: 8px 12px; border: 1px solid #cbd5e1; border-radius: 8px;"
          >
        ...
        <div style="margin-top: 24px; display: flex; justify-content: flex-end; gap: 12px;">
          <button class="btn btn-outline" @click="showAddQuestionModal = false">取消</button>
          <button class="btn btn-primary" @click="saveNewQuestion">保存题目</button>
        </div>
      </div>
    </div>
  </div>
